  ...
  return (
    <div className="bg-[#121121] pb-[3rem] pt-[4rem] md:pt-[8rem]">
        <div className="grid grid-cols-1 md:grid-cols-2 w-[80%]  mx-auto gap-[3rem] items-center">
            <div>
                ...
                <div className="mb-[3rem] flex items-center md:space-x-10 ">
                    ...
                    <p className="text-[19px] text-slate-300 w-[80%]">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed, reiciendis minima.
                         Nobis atque sit accusamus facere optio quo, aperiam error,
                          libero exercitationem eveniet dolorem debitis earum quae in nihil perferendis?
                    </p>
                </div>
            ...
            <div className="lg:w-[500px] mx-auto md:mx-0 mt-[2rem] lg:mt-0 lg:h-[500px] w-[300px] h-[300px] mx-[2rem] relative">
                    <img src="" alt="user" className="relative z-[11] w-[100%] h-[100%]  object contain" />
